        ...
        <div class="col-xs-12">
          <?php echo $this->session->flashdata('pesan'); ?>
            <div class="box">
                ...
                <div class="box-body">
                    <form method="post" action="<?php echo base_url('admin/nilai/input_nilai_aksi/'. $matkul['id_matkul']); ?>">
                        ...
                        <br>
                        <p align="center">
                        <a href="<?php echo base_url('admin/Nilai/getMatkul/'.$matkul['id_jurusan']) ?>" class="btn btn-warning"> Kembali</a>

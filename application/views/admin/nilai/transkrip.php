          ...
          <?php echo $this->session->flashdata('pesan'); ?>
            <div class="box">
                <div class="box-header">
                    <h3>Data Transkrip Mahasiswa</h3>  
                </div>
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped" style="font-size:13px;">
                        ...
                        <tbody>
                            ...
                            <?php if ($row->nim != $this->session->userdata('nama_mhs')) : ?>
                            <tr>
                                <td><?php echo $i++; ?></td>
                                ...
                                <td>
                                    <a title="Print Transkrip" target="_blank" href="<?php echo base_url('admin/nilai/print/'.$row->id_mahasiswa); ?>" class="btn btn-sm btn-primary"><i class="fa fa-print"></i></a>
                                </td>
                            </tr>
                            <?php endif; ?>
                            <?php } ?>
          ...
          <div class="modal-dialog">
            ...
            <form role="form" method="post" action="<?php echo base_url('admin/Mahasiswa/add'); ?>" >
              <div class="box-body">
                ...
                <div class="form-group">
                  <label style="color: gray;" for="nama">Nama Depan</label>

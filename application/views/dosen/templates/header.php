        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <?php if($dosen['photo'] == NULL) { ?>
               ...
               <?php }else{ ?> 
              <img class="user-image" src="<?php echo base_url('assets/img/uploads/'.$dosen['photo']); ?>" alt="User profile picture">
                <?php } ?>
              <span class="hidden-xs"><?php echo $this->session->userdata('nama_dosen'); ?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                <?php echo $this->session->userdata('nama_dosen'); ?> - <?php echo $this->session->userdata('username'); ?>
                </p>
              </li>
              <!-- Menu Footer-->
